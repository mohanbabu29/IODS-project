...
setwd("~/IODS-project/Data 2")

# Save created data to folder 'data' as an Excel worksheet
#install.packages("openxlsx")
library(openxlsx)
write.xlsx(learning2014,file="~/IODS-project/data 2/learning2014.xlsx")

# Read the data back to R and check that structure and a few first observations look the same
library(readxl)

readtest <- read.xlsx("~/IODS-project/data 2/learning2014.xlsx")
readtest2 <- readxl::read_excel("~/IODS-project/data 2/learning2014.xlsx") %>%
